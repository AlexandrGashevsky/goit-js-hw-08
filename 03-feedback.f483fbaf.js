...
"use strict";var e=t(require("lodash/debounce"));function t(e){return e&&e.__esModule?e:{default:e}}const a={},r=document.querySelector(".feedback-form"),o=document.querySelector(".feedback-form input"),l=document.querySelector(".feedback-form textarea");let c;r.addEventListener("submit",e=>{e.preventDefault();const t={email:o.value,message:l.value};console.log(t),e.currentTarget.reset(),localStorage.removeItem("feedback-form-state")}),r.addEventListener("input",(0,e.default)(e=>{a[e.target.name]=e.target.value,localStorage.setItem("feedback-form-state",JSON.stringify(a)),console.log(a)},500)),null!==localStorage.getItem("feedback-form-state")&&(c=JSON.parse(localStorage.getItem("feedback-form-state")),o.value=c.email,l.value=c.message);
},{"lodash/debounce":"CXfR"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.f483fbaf.js.map